...
import { StyleSheet, Text, View, Button, ImageBackground,Platform, StatusBar , ScrollView, SafeAreaView, Image, TextInput, TouchableOpacity , Dimensions} from 'react-native';
...
{/*<Text style={{fontWeight: 'bold', fontSize: 20}} onChangeText={date=>setText(date)}>{text}</Text>
